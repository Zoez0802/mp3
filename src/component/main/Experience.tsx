        ...
        <main className="timeline">
            ...
            <section id="timeline">
                ...
                <div>
                    ...
                    <p>Boston, MA</p>
                    <ul>
                        <li>Developed a JRPG-inspired game using JavaScript and p5.js, incorporating HTML and CSS for styling and interface design.</li>
                        <li>Implemented interactive gameplay features, including NPC dialogues, quest progression, and narrative-driven exploration.</li>
                    </ul>
                </div>
            </section>
        </main>
